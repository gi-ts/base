...
export function construct_gobject(gtype: GObject.GType, data: string, length: number): T;
export function from_string(str: string): Node | null;
export function gobject_deserialize(gtype: GObject.GType, node: Node): T;
export function gobject_from_data(gtype: GObject.GType, data: string, length: number): T;
